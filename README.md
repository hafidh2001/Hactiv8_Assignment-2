...
```bash
$ git clone <remote_repo> (ex: git clone https://github.com/hafidh2001/Hactiv8_Assignment-2.git)
# or clones to specific branches
$ git clone -b <branch> <remote_repo> (ex: git clone -b development https://github.com/hafidh2001/Hactiv8_Assignment-2.git)
```
